...
/**
 * @author Sjonnie Created on 9/9/2018.
 */
public class ScriptMemory {
    ...
    /**
     * Returns the previous script info according to the current position (or
     * null if we don't have it). Automatically decrements the position.
     *
