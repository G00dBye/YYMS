...
public class ScriptManagerImpl implements ScriptManager {
    ...
    /**
     * Helper function that ensures that selections have the appropriate type
     * (AskMenu).
     *
     * @param text
     * @param nmt
...
//            chr.write(User.setDamageSkin(chr));
    ...
    public void blind(int enable, int x, int color, int unk1, int unk2, int time) {
        chr.write(CField.fieldEffect(FieldEffect.blind(enable, x, color, unk1, unk2, time, 0)));
    }

    public void blind(int enable, int x, int color, int unk1, int unk2, int time, int unk3) {
        chr.write(CField.fieldEffect(FieldEffect.blind(enable, x, color, unk1, unk2, time, unk3)));
    }

    public void OnOffLayer_On(int term, String key, int unk1, int unk2, int z, String path, int origin, int unk5, int unk6, int unk7) {
        chr.write(CField.fieldEffect(FieldEffect.OnOffLayer_On(term, key, unk1, unk2, z, path, origin, unk5, unk6, unk7)));
    }

    public void OnOffLayer_Move(int term, String key, int dx, int dy) {
        chr.write(CField.fieldEffect(FieldEffect.OnOffLayer_Move(term, key, dx, dy)));
    }

    public void OnOffLayer_Off(int term, String key, int unk) {
        chr.write(CField.fieldEffect(FieldEffect.OnOffLayer_Off(term, key, unk)));
    }
