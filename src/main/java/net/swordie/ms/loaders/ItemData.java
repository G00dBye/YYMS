...
public class ItemData {
     ...
     * @param randomizeStats whether or not to randomize the stats of the
     * created object
     * @return A deep copy of the default values of the corresponding Equip, or
     * null if there is no equip with itemId <code>itemId</code>.
     */
        ...
        for (String subMap : subMaps) {
            ...
            for (File file : files) {
                ...
                for (Node mainNode : nodes) {
                    ...
                    if (mainName != null) {
                        //wz\Character.wz\Face\目录下有个CommonFaceCN.img.xml这个不用解析，删除
