...
public class MobTemporaryStat {
    ...
    /**
     * Checks if this MTS has a burn skill by a given skillID and owner
     * character id. If the given owner's id is 0, ignores the given owner id.
     *
     * @param skillID the skill id of which the burn should exist
     * @param ownerCID the burn skill's owner's id that should match (or 0 if
     * ignored)
    ...
    /**
     * Adds a new MobStat to this MobTemporaryStat. Will immediately broadcast
     * the reaction to all clients. Only works for user skills, not mob skills.
     * For the latter, use {@link
    ...
    /**
     * Adds a new MobStat to this MobTemporary stat. Will immediately broadcast
     * the reaction to all clients. Only works for mob skills, not user skills.
     * For the latter, use {@link
