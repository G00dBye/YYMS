...
public class EventManager {
    ...
    /**
     * Adds and returns an event that executes after a given initial delay, and
     * then after every delay. See
     * https://stackoverflow.com/questions/24649842/scheduleatfixedrate-vs-schedulewithfixeddelay
     * for difference between this method and addFixedDelayEvent.
     *
     * @param runnable The method that should be run
     * @param initialDelay The time that it should take before the first
     * execution should start
     * @param delay The time it should (in ms) take between the start of
     * execution n and execution n+1
     * @return The created event (ScheduledFuture)
     */
     ...
     * @param initialDelay The time that it should take before the first
     * execution should start
     * @param delay The time it should take between the start of execution n and
     * execution n+1
    ...
    /**
     * Adds and returns an event that executes after a given initial delay, and
     * then after every delay after the task has finished. See
     * https://stackoverflow.com/questions/24649842/scheduleatfixedrate-vs-schedulewithfixeddelay
     * for difference between this method and addFixedDelayEvent.
     *
     * @param runnable The method that should be run
