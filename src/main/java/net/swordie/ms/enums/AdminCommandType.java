...
public enum AdminCommandType {
    ...
    /**
     *
     * /setmobact - [Mob ID], [Action] (Client Side) TODO: check actions for
     * this /honorinfo - [No Args] (Client Side) /pg - no idea what it does
     * /scriptrun - only log /mrh - only log /setGaugeMax - only log /pos -
     * sending GET_CHARACTER_POSITION to server /setheadnotice - only log
     * /attackboss - only log /uitest - [SHORT UI ID] /m, /map -
     * USER_TRANSFER_FIELD_REQUEST with specific map [01 00 E1 F5 05 B4 E2 EE 05
     * 00 00 00 00 00] /worldnotice - only log /showcodeinfo - client side shows
     * id for items/maps/quests /getservertime - sends GET_SERVER_TIME to server
     * /flag - only log /ch - change the channel for u. /c - whishper ?
     * /alertall - sending BROADCAST_MSG to server. /slidebrg - sending
     * BROADCAST_MSG to server. /slidebx - sending BROADCAST_MSG to server.
     * /slideall - sending BROADCAST_MSG to server. /slideallx - sending
     * BROADCAST_MSG to server. /slidech - sending BROADCAST_MSG to server.
     * /slidechx - sending BROADCAST_MSG to server. /slidemap - sending
     * BROADCAST_MSG to server. /slidemapx - sending BROADCAST_MSG to server.
     * /slideax - sending BROADCAST_MSG+SLIDE_REQUEST to server.
     * /sethitavoidperiod - client side god mod :P /releaseMemory /reloadMemory
     * /showmobattack /showmobskill /showpolygon /showboundingbox /noticeall -
     * sending BROADCAST_MSG to server. /alertch - sending BROADCAST_MSG to
     * server. /noticech - sending BROADCAST_MSG to server. /alertmap - sending
     * BROADCAST_MSG to server. /alertm - sending BROADCAST_MSG to server.
     * /noticemap - sending BROADCAST_MSG to server. /level1 - giving to you
     * level 1 monster sack. /level2 - giving to you level 2 monster sack.
     * /level3 - giving to you level 3 monster sack. /level4 - giving to you
     * level 4 monster sack. /level5 - giving to you level 5 monster sack.
     * /level6 - giving to you level 6 monster sack. /level7 - giving to you
     * level 7 monster sack. /level8 - giving to you level 8 monster sack.
     * /package1 - giving to you level 1~3 monster sack. /package2 - giving to
     * you level 4~7 monster sack. /noticehe - sending BROADCAST_MSG to
     * server.(ATTENTION! This is Athena Pierce! A horde of monsters is headed
     * for Henesys! All brave warriors are ordered to Henesys immediately! Let
     * the battle begin!) /noticeel - sending BROADCAST_MSG to
     * server.(ATTENTION! This is Grendel the Really Old! A horde of monsters is
     * headed for Ellinia! All brave warriors are ordered to Ellinia
     * immediately! We shall prevail!) /noticepe - sending BROADCAST_MSG to
     * server.(ATTENTION! This is Dances with Balrog! A horde of monsters is
     * headed for Perion! All brave warriors are ordered to Perion immediately!
     * May your sword be as strong as your will!) /noticekc - sending
     * BROADCAST_MSG to server.(ATTENTION! This is the Dark Lord! A horde of
     * monsters is headed for Kerning City! All brave warriors are ordered to
     * Kerning City immediately! Let us teach our enemies the folly of their
     * actions!) /noticelh - sending BROADCAST_MSG to server.(ATTENTION! This is
     * Vikin! A horde of monsters is headed for Lith Harbor! All brave warriors
     * are ordered to Lith Harbor immediately! It's battle time!) /noticeor -
     * sending BROADCAST_MSG to server.(ATTENTION! This is Ericson! A horde of
     * monsters is headed for Orbis! All brave warriors are ordered to Orbis
     * immediately! Fight hard, fight well!) /noticelu - sending BROADCAST_MSG
     * to server.(ATTENTION! This is Marcel! A horde of monsters is headed for
     * Ludibrium! All brave warriors are ordered to Ludibrium immediately! Show
     * these punks we don't toy around!) /noticefo - sending BROADCAST_MSG to
     * server.(ATTENTION! This is a distress call! A horde of monsters is headed
     * for Folk Town! All brave warriors are ordered to Folk Town immediately!
     * May the spirit of the Maple Tree guide your weapon!) /startnotice -
     * sending BROADCAST_MSG to server.(The monsters have begun a ruthless
     * assault! Stand your ground, hold the line and protect the town!)
     * /endnotice - sending BROADCAST_MSG to server.(Excellent work! The town
     * has withstood the invasion of the monsters unscathed, thanks to your
     * superior battle skills. If you're the person that collected "The Force of
     * Darkness," please head to the Maple Administrator located near you. We
     * thank you again!) /start - sending COCONUT_HIT ? /open - opening event ?
     * (enabling portal join00). /showtooltip - showing item info /setheadnotice
     * - not sure what it does, but it client side. /attackboss - not sure what
     * it does, but it client side. /grayfield - client side /resetgrayfield -
     * client side /usertimertest - ? /cleartemplayer - client side /lightness -
     * ? /lightnessoff - ? /torchtest - ? /torchtest2 - ? /worldtransfer -
     * sending WORLD_TRANSFER_REQUEST to server. /worldtransferS - sending
     * WORLD_TRANSFER_REQUEST to server. /mobphase - showing mob phase
     * /rwgetbarrier /demiantree - sends mob skill command /setobjvisiblelevel -
     * ? /incobjvisiblelevel - ? /decobjvisiblelevel - ? /cpsview - ? /backspeed
     * - ? /mvpgrade - showing your mvp grade. /mvpgrade_yes - ? /mvp_clear_dp -
     * ? /mvpinfo - showing extra mvp info. /reqMCreward - sending
     * MONSTER_COLLECTION_COMPLETE_REWARD_REQ to server. /yoyolog /loadcmd
     * /tenthInvite /mYutInvite /smYutInvite /bingomulti /texturememory
     * /getnxrecord /saveJournal - sending JOURNAL_AVATAR_REQUEST to server.
     * /loadJournal - sending JOURNAL_AVATAR_REQUEST to server. /cheatRPS -
     * sends G_S_R_P_S_FORCE_SELECT to server /rotateCamera - be careful with
     * that it can crash your MS. /setCamera /changeBGM /sound /showMeso
     * /getnextexp /hackSummon /jaguarHack /getskilllevel
     */
