...
public class OutPacket extends Packet {
     ...
     *
     * @param data The data this net.swordie.ms.connection.packet has to be
     * initialized with.
     */
    ...
    /**
     * Creates a new OutPacket with a given header. Immediately encodes the
     * header's short value.
     *
    ...
    /**
     * Encodes a byte array to this OutPacket. Named like this to prevent
     * autocompletion of "by" to "byteArray" or similar names.
     *
    ...
    /**
     * Encodes a String to this OutPacket. Structure: short(size) + char array
     * of <code>s</code>.
     *
    ...
    /**
     * Writes a String as a character array to this OutPacket. If
     * <code>s.length()</code> is smaller than length, the open spots are filled
     * in with zeros.
     *
     * @param s The String to encode.
