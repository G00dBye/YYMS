...
public class CIGCipher {
    ...
    /**
     * Transforms and shuffles a 4-byte key source with the provided previous
     * byte of the keys initial sequence.
     *
     * @Author Eric Smith: original conversion from GMS Client to JAVA.
     * @Author Kaz Voeten: modified code to match shortened version in the later
     * GMS clients.
     *
