...
//        temporaryStatManager.getRemovedStats().forEach((cts, option) -> outPacket.encodeInt(0));
    ...
    /**
     * Returns a net.swordie.ms.connection.packet for messages with the
     * following {@link MessageType}:<br>
...
//        OutPacket outPacket = new OutPacket(OutHeader.MONSTER_LIFE_INVITE_ITEM_RESULT);
     ...
     * @param msg when returnResult is: 0 or 1: Anything: Golden hammer
     * refinement applied 2: 0: Increased available upgrade by 1 1: Refining
     * using golden hammer failed 3: 1: Item is not upgradable 2: 2 upgrade
     * increases have been used already 3: You can't vicious hammer non-horntail
     * necklace
     * @param upgradesLeft amount of upgrades left. NOTE: ((v9 >> 8) & 0xFF) -
     * v9 + 2) (where v9 = upgradesLeft)
