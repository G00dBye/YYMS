...
public class Field {
    ...
    /**
     * Drops an item to this map, given a {@link Drop}, a starting Position and
     * an ending Position. Immediately broadcasts the drop packet.
     *
     ...
     * @param ignoreTradability if the drop should ignore tradability (i.e.,
     * untradable items won't disappear)
     */
    ...
    /**
     * Drops a {@link Drop} according to a given {@link DropInfo DropInfo}'s
     * specification.
     *
     * @param dropInfo The
     * @param posFrom The Position that hte drop starts off from.
     * @param posTo The Position where the drop lands.
     * @param ownerID The owner's character ID. Will not be able to be picked up
     * by Chars that are not the owner.
     */
    ...
    /**
     * Drops a {@link Drop} at a given Position. Calculates the Position that
     * the Drop should land at.
     *
     ...
     * Not all drops are guaranteed to be dropped, as this method calculates
     * whether or not a Drop should drop, according to the DropInfo's prop
     * chance.
     *
    ...
    /**
     * Goes through all MobGens, and spawns a Mob from it if allowed to do so.
     * Only generates when there are Chars on this Field, or if the field is
     * being initialized.
     *
