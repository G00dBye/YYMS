...
public class Util {
    ...
    /**
     * Gets a random element from a given List. This is done by utilizing
     * {@link #getRandom(int)}.
     *
    ...
    /**
     * Gets a random element from a given Collection. This is done by making an
     * array from the Collection and calling
    ...
    /**
     * Returns a bitwise OR of two arrays. Takes the length of arr1 as the
     * return array size. If arr2 is smaller, will return an
     * {@link ArrayIndexOutOfBoundsException}.
     *
     * @param arr1 The first array
     * @param arr2 The second array
     * @return The result of using bitwise OR on all contents of arr1 to arr2
     * such that for all index i with i < arr1.length: res[i] == arr1[i] |
     * arr2[i]
     */
    ...
    /**
     * Returns a random number from 0 up to (and <b>including</b>) inclBound.
     * Creates a new Random class upon call. If a bound smaller or equal to 0 is
     * given, always returns 0.
     *
    ...
    /**
     * Returns a random number from <code>start</code> up to <code>end</code>.
     * Creates a new Random class upon call. If <code>start</code> is greater
     * than <code>end</code>, <code>start</code> will be swapped with
     * <code>end</code>.
     *
    ...
    /**
     * Creates a byte array given a string. Ignores spaces and the '|'
     * character.
     *
     * @param s The String to transform
     * @return The byte array that the String contained (if there is any, some
    ...
    /**
     * Adds right padding given an initial String, padding character and maximum
     * length. If the input String is longer than the given maximum length, the
     * String length is taken instead (effectively doing nothing, as there is
     * nothing to pad.
     *
    ...
    /**
     * Adds left padding given an initial String, padding character and maximum
     * length. If the input String is longer than the given maximum length, the
     * String length is taken instead (effectively doing nothing, as there is
     * nothing to pad.
     *
    ...
    /**
     * Gets a single element from a collection by using a predicate. Returns a
     * random element if there are multiple elements for which the predicate
     * holds.
     *
     ...
     * @return An element for which the predicate holds, or null if there is
     * none
     */
    ...
    /**
     * Gets a single element from an array by using a predicate. Returns a
     * random element if there are multiple elements for which the predicate
     * holds.
     *
    ...
    /**
     * Returns the long as an int, or Integer.MAX_VALUE if it exceeds the
     * maximum int value.
     *
     * @param num the number that should be capped at Integer.MAX_VALUE
     * @return <code>num</code> if the number is small enough, else
     * Integer.MAX_VALUE
     */
