...
public class FileTime implements Serializable {
    ...
    /**
     * Creates a new FileTime from a given long, by splitting up the long into a
     * low and high part
     *
    ...
    /**
     * Creates a new FileTime from the current time
     * (System.currentTimeMillis()). Ensures the date is correctly c alculated
     * for the client.
     *
    ...
    /**
     * Converts this FileTime (storing epoch millis) to a format that the client
     * expects.
     *
    ...
    /**
     * Creates a new FileTime from a given date. Ensures the date is correctly
     * calculated for the client.
     *
