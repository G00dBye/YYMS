...
public class Rect {
     ...
     * @return if the position is not null and inside this Rect (rect.left <
     * pos.x < rect.right && rect.top < pos.y < rect.bottom.
     */
    ...
    /**
     * Move this Rect left by the width, effectively flipping around the left
     * edge.
     *
    ...
    /**
     * Move this Rect right by the width, effectively flipping around the right
     * edge.
     *
     * @return The resulting Rect from the move.
     */
