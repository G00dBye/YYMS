...
public class CharacterPotentialMan {
    ...
    /**
     * Adds a potential to the char's potential list. Will override the old one
     * with the same key if one exists. Also sends a packet to the client to
     * indicate the change.
     *
    ...
    /**
     * Removes a potential from the char's potential list by key. Will do
     * nothing if there is no such potential. Also sends a packet to the client
    ...
    /**
     * Returns the current grade of a Char's potential, which is equivalent to
     * the highest potential of the Char.
     *
