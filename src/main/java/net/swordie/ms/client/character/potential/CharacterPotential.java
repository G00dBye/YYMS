...
/**
 * Class containg the properties of a single character potential. Note that this
 * class is equal to another instance iff the <code>key</code> properties are
 * equal! Created on 5/27/2018.
 */
@Entity
