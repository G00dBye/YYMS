...
//        outPacket.encodeInt(getPrevBonusExpRate());
    ...
    /**
     * Resets the potential of this equip's base options. Takes the value of an
     * ItemGrade (1-4), and sets the appropriate values. Also calculates if a
     * third line should be added.
     *
     * @param val The value of the item's grade
     * (HiddenRare~HiddenLegendary).getVal().
