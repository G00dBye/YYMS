 ...
 *
 * @author Sjonnie Created on 6/20/2018.
 */
public class PartyDamageInfo {
     ...
     * @param percDamage the percentage damage done compared to the total mob's
     * health
     */
    ...
    /**
     * Distributes the exp of the mobs amongst the characters. Formula used is
     * taken from https://strategywiki.org/wiki/MapleStory/Formulas#Party_EXP.
     */
