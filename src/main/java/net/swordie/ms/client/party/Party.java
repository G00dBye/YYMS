...
public class Party implements Encodable {
    ...
    /**
     * Clears the current Fields. Will return any character that is currently on
     * any of the Fields to the Field's return field.
     *
    ...
    /**
     * Returns the Field corresponding to the provided fieldID. If there is
     * none, creates one.
     *
    ...
    /**
     * Returns the average party member's level, according to the given Char's
     * field.
     *
    ...
    /**
     * Gets a list of party members in the same Field instance as the given
     * Char, excluding the given Char.
     *
